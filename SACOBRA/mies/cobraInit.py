...
sys.path.append('..')
from utility_files.defaultRI import defaultRI
from utility_files.defaultTR import defaultTR
from utility_files.defaultSAC import defaultSAC
from utility_files.defaultSAC import setOpts
from utility_files.lhs import lhs 
from utility_files.transformLHS import transformLHS
...
def cobraInit(xStart, fn, fName, lower, upper, nConstraints, feval, 
    ...
    cobra['integer_indices'] = integer_indices
