...
from utility_files.RbfInter import trainCubicRBF
from utility_files.RbfInter import predictRBFinter
from utility_files.RbfInter import distLine
from utility_files.RbfInter import interpRBF
...
def save_results(fName, cobraSeed, results_arr):
    ...
    fold = "without_plog"
    path = '../results/'+fold+'/rbf_rounding/'+ fName
